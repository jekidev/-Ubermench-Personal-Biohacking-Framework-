...
export function createDefaultSkillRegistry(): SkillRegistry {
  ...
  registry.register({ id: 'scientific-literature-search', name: 'Scientific literature search', description: 'Searches open literature via paper-search-mcp and Europe PMC. Never uses Sci-Hub.', triggers: ['pubmed', 'paper search', 'literature', 'europe pmc', 'arxiv'], tools: ['paper-search', 'europe-pmc'], enabled: true })
