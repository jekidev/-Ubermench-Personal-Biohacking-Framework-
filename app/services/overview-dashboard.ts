...
export const OVERVIEW_NAVIGATION: OverviewNavigationCard[] = [
  ...
  { label: 'Workouts', to: '/longevity/workouts', description: 'MIT exercise catalog + local session log on this phone' },
  { label: 'Sleep', to: '/longevity/sleep', description: 'Garmin sleep_score if imported + local sleep log' },
  { label: 'Diet', to: '/longevity/diet', description: 'Standing diet protocol + local meal log — not a USDA dump' },
  { label: 'Stack', to: '/longevity/stack', description: 'Enter the supplements and medications you take' },
  { label: 'Meditation', to: '/longevity/meditation', description: 'Local session log. Fearprime stays the PTSD home.' },
  { label: 'News', to: '/news', description: 'Public-agency RSS with source + time. Not Europe PMC.' },
