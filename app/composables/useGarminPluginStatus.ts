import { loadGarminPluginStatus, withGarminStatusGuidance, type GarminPluginStatus } from '../services/garmin-plugin-status'

export const GARMIN_PLUGIN_STATUS_STATE_KEY = 'ubermensch-garmin-plugin-status'

export const EMPTY_GARMIN_PLUGIN_STATUS: GarminPluginStatus = withGarminStatusGuidance({
