...
export interface MedicationRecord { id: string; name: string; dose?: string; frequency?: string; startedAt?: string; stoppedAt?: string; notes?: string; active: boolean }
export interface SupplementRecord { id: string; name: string; dose?: string; frequency?: string; timing?: string; notes?: string; active: boolean }
...
export interface PersonalBiologyProfile {
  version: 1
