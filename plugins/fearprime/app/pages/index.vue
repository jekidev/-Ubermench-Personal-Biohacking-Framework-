  ...
  <div class="min-h-screen bg-default text-default">
    ...
    <main class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <section class="grid gap-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <UCard><div class="space-y-3"><p class="text-sm text-muted">Next-best-test</p><p class="text-lg font-semibold">{{ nextStep }}</p><p class="text-sm text-muted">Systemet foreslår først måling og hypothesis discrimination; medicinske beslutninger er ikke automatiserede.</p><UBadge color="warning" variant="subtle">Clinician review hvor relevant</UBadge></div></UCard>
      </section>
      ...
      <section class="grid gap-4 lg:grid-cols-2">
        ...
        <UCard><template #header><h2 class="font-semibold">Phenotype-status</h2></template><div class="space-y-3 text-sm"><div class="flex items-center justify-between"><span>F3 · Acquisition</span><UBadge color="neutral" variant="subtle">Afventer data</UBadge></div><div class="flex items-center justify-between"><span>F4 · Consolidation</span><UBadge color="neutral" variant="subtle">Afventer data</UBadge></div><div class="flex items-center justify-between"><span>F5 · Generalisation</span><UBadge color="neutral" variant="subtle">Afventer data</UBadge></div><div class="flex items-center justify-between"><span>F6 · Relapse</span><UBadge color="neutral" variant="subtle">Afventer data</UBadge></div></div></UCard>
      </section>
    </main>
  </div>
</template>
