...
export const MCP_SERVER_REGISTRY: McpServerRegistryEntry[] = [
  ...
  {
    serverId: 'supermemory',
    connectorId: 'supermemory',
    executable: 'npx',
    allowedArgs: ['-y', 'supermemory-mcp'],
    description: 'Local SuperMemory MCP with vector search and knowledge graph (no API key)',
    enabledByDefault: false,
    auth: 'none',
  },
  {
    ...
    connectorId: 'mem0',
    executable: 'npx',
    allowedArgs: ['-y', '@mem0/mcp-server'],
    description: 'Mem0 cloud memory MCP server',
    enabledByDefault: false,
    auth: 'env',
