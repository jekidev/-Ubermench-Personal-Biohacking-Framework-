...
description: Use the optional Local Deep Research sidecar for cited summaries. Do not merge LDR into the Nuxt app.
---

# Local Deep Research

Optional sidecar. Requires `ldr-mcp` and explicit approval.
